...
class ColorsCode{
  ...
  static Color grayColor100 = const Color(0x006D6D6D);
  static Color grayColor300 = const Color(0x00515151);
  static Color purpleColor = const Color(0x00BE0ED5);
  static Color purpleColorBright = const Color(0x00C426D9);
  static Color purpleColorLight = const Color(0x00F0DEF2);
